  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'KIỂM DUYỆT ĐÁNH GIÁ',
          style: TextStyle(color: Colors.pinkAccent, fontWeight: FontWeight.bold, fontSize: 14, letterSpacing: 1),
        ),
        leading: IconButton(
                    ...
                    Row(
                      children: [
                        ...
                        TextButton.icon(
                          ...
                          label: const Text('Xoá', style: TextStyle(color: Colors.redAccent, fontSize: 12, fontWeight: FontWeight.bold)),
